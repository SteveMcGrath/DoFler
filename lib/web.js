...
http.listen(config.AppServer.port,config.AppServer.host, function(){
	console.log('Application Web Server is listening on: '+ config.AppServer.host +':' + config.AppServer.port);
})
